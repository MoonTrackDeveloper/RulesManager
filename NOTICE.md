...
Rules Manager (Copyright © 2026 广州月之轨迹科技有限公司) is **proprietary
software**. It incorporates the third-party open source components listed
below. See [LICENSE](LICENSE) for Rules Manager itself.

This notice accompanies binary distributions published via GitHub Releases.

---

## npm (bundled in application UI)
...
## Rust (bundled in application runtime)
...
| bitflags | 2.12.1 | Apache-2.0 OR MIT |
...
| libgit2-sys | 0.17.0+1.8.1 | Apache-2.0 OR MIT |
...
| zbus | 5.16.0 | MIT |
| zerocopy | 0.8.50 | Apache-2.0 OR BSD-2-Clause OR MIT |
| zerocopy-derive | 0.8.50 | Apache-2.0 OR BSD-2-Clause OR MIT |
...
Components under permissive licenses (MIT, Apache-2.0, BSD, ISC, etc.) are
used in compliance with their attribution and notice requirements. Full license
texts are available from the respective project repositories and registries
(npmjs.com, crates.io).

If you believe a component is missing from this notice, contact
https://www.moontrack.cloud/
